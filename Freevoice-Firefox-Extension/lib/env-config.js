...
// Use browser.runtime.getURL for Firefox (moz-extension://)
const libPath = extensionUrl.includes('moz-extension://')
  ? (typeof browser !== 'undefined' ? browser.runtime.getURL('lib/') : './')
  : './';
